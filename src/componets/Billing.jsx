...
const Billing = () => (
  <section className={`${layout.sectionReverse}`} id='product'>
    <div className={`${layout.sectionImgReverse}`}>
      ...
      <div className='absolute z-[3] -left-1 top-0 w-[50%]
       h-[50%] rounded-full white__gradient'/>
      <div className='absolute z-[0] -left-1 bottom-0 w-[50%]
    ...
    <div className={`${layout.sectionInfo}`}>
      ...
      >Easily control your
      <br className='sm:block hidden'/> billing & invoicing.</h1>
      ...
      mt-6">
        ...
        <img className="w-[128px] h-[42px] object-contain cursor-pointer" src={google} alt="goolg-play" />
      </div>
    </div>
  </section>
)
